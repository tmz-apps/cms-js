...
import DetailsTab from '@tmz-apps/cms-js/plugins/iam/components/user-screen/DetailsTab.js';
import RolesTab from '@tmz-apps/cms-js/plugins/iam/components/user-screen/RolesTab.js';
