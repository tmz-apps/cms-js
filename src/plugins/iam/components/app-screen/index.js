...
import DetailsTab from '@tmz-apps/cms-js/plugins/iam/components/app-screen/DetailsTab.js';
import RolesTab from '@tmz-apps/cms-js/plugins/iam/components/app-screen/RolesTab.js';
