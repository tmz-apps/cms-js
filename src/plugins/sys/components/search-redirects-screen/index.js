...
import SearchForm from '@tmz-apps/cms-js/plugins/sys/components/search-redirects-screen/SearchForm.js';
import createRowClickHandler from '@tmz-apps/cms-js/utils/createRowClickHandler.js';

const CreateRedirectModal = lazy(() => import('@tmz-apps/cms-js/plugins/sys/components/create-redirect-modal/index.js'));
