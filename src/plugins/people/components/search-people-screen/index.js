...
import SearchForm from '@tmz-apps/cms-js/plugins/people/components/search-people-screen/SearchForm.js';
import createRowClickHandler from '@tmz-apps/cms-js/utils/createRowClickHandler.js';

const CreatePersonModal = lazy(() => import('@tmz-apps/cms-js/plugins/people/components/create-person-modal/index.js'));
