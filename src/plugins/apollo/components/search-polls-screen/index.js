...
import SearchForm from '@tmz-apps/cms-js/plugins/apollo/components/search-polls-screen/SearchForm.js';
import createRowClickHandler from '@tmz-apps/cms-js/utils/createRowClickHandler.js';

const CreatePollModal = lazy(() => import('@tmz-apps/cms-js/plugins/apollo/components/create-poll-modal/index.js'));
