...
import DetailsTab from '@tmz-apps/cms-js/plugins/canvas/components/page-screen/DetailsTab.js';
import AssetsTab from '@tmz-apps/cms-js/plugins/canvas/components/page-screen/AssetsTab.js';
