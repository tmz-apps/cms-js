...
import VideoPickerField from '@tmz-apps/cms-js/plugins/ovp/components/video-screen/VideoPickerField.js';
import SyndicationCard from '@tmz-apps/cms-js/plugins/ovp/components/video-screen/SyndicationCard.js';
