...
import DetailsTab from '@tmz-apps/cms-js/plugins/ovp/components/video-screen/DetailsTab.js';
import AssetsTab from '@tmz-apps/cms-js/plugins/ovp/components/video-screen/AssetsTab.js';
...
import MezzaninePreviewCard from '@tmz-apps/cms-js/plugins/ovp/components/video-screen/MezzaninePreviewCard.js';
import SaveNodeButton from '@tmz-apps/cms-js/plugins/ncr/components/save-node-button/index.js';
import MediaLiveChannelControls from '@tmz-apps/cms-js/plugins/ovp/components/media-live-channel-controls/index.js';
