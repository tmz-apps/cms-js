...
import SearchForm from '@tmz-apps/cms-js/plugins/curator/components/search-galleries-screen/SearchForm.js';
import createRowClickHandler from '@tmz-apps/cms-js/utils/createRowClickHandler.js';

const CreateGalleryModal = lazy(() => import('@tmz-apps/cms-js/plugins/curator/components/create-gallery-modal/index.js'));
