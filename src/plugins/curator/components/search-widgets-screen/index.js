...
import SearchForm from '@tmz-apps/cms-js/plugins/curator/components/search-widgets-screen/SearchForm.js';
...
const CreateWidgetModal = lazy(() => import('@tmz-apps/cms-js/plugins/curator/components/create-widget-modal/index.js'));
