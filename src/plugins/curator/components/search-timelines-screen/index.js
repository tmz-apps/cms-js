...
import SearchForm from '@tmz-apps/cms-js/plugins/curator/components/search-timelines-screen/SearchForm.js';
import createRowClickHandler from '@tmz-apps/cms-js/utils/createRowClickHandler.js';

const CreateTimelineModal = lazy(() => import('@tmz-apps/cms-js/plugins/curator/components/create-timeline-modal/index.js'));
