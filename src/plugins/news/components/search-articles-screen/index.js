...
import SearchForm from '@tmz-apps/cms-js/plugins/news/components/search-articles-screen/SearchForm.js';
...
const CreateArticleModal = lazy(() => import('@tmz-apps/cms-js/plugins/news/components/create-article-modal/index.js'));
